...
- fix: Support SLIP44 format changes ([#204](https://github.com/MetaMask/slip44/pull/204))
- Update with latest data as of 2026-06-02 ([#202](https://github.com/MetaMask/slip44/pull/202))
- ci: Upgrade Yarn to 4.16.0 and update `action-npm-publish` to v6 ([#203](https://github.com/MetaMask/slip44/pull/203))
- Update with latest data as of 2026-04-02 ([#200](https://github.com/MetaMask/slip44/pull/200))
